...
public class ToJSON {
         ...
         * @throws Exception
         */
        public JSONArray toJSONArray(ResultSet rs, ArrayList<String> attr) throws Exception {
             ...
             while( rs.next() ) {
                 ...
                 for (int i=1; i<numColumns+1; i++) {
                     ...
                     if(rsmd.getColumnType(i)==java.sql.Types.ARRAY){
                             ...
                             while(num < len){
                               columnField = attr.get(num);
                               data = rs.getString(columnField);
                               keyArr.put(data);
                             ...
                             keyobj.put("key", keyArr);
                             
                             columnField = "sales_total";
                             data = rs.getString(columnField);
                             //valueobj.put("value", data);
                             keyobj.put("value", data);
